...
#ifndef EPUB_VIEWER_SWIFT_H
#define EPUB_VIEWER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="epub_viewer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11epub_viewer21SwiftEpubViewerPlugin")
@interface SwiftEpubViewerPlugin : NSObject <FolioReaderPageDelegate, FlutterPlugin, FlutterStreamHandler>
