...
#ifndef EPUBVIEWERKIT_SWIFT_H
#define EPUBVIEWERKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EpubViewerKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif



SWIFT_CLASS("_TtC13EpubViewerKit6FRBook")
@interface FRBook : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13EpubViewerKit10FRResource")
@interface FRResource : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13EpubViewerKit11FRResources")
@interface FRResources : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13EpubViewerKit14FRTocReference")
...
SWIFT_CLASS("_TtC13EpubViewerKit11FolioReader")
...
@interface FolioReader (SWIFT_EXTENSION(EpubViewerKit))
...
SWIFT_CLASS("_TtC13EpubViewerKit22FolioReaderAudioPlayer")
...
@interface FolioReaderAudioPlayer (SWIFT_EXTENSION(EpubViewerKit)) <AVAudioPlayerDelegate>
...
@interface FolioReaderAudioPlayer (SWIFT_EXTENSION(EpubViewerKit)) <AVSpeechSynthesizerDelegate>
...
SWIFT_CLASS("_TtC13EpubViewerKit17FolioReaderCenter")
...
SWIFT_PROTOCOL("_TtP13EpubViewerKit23FolioReaderPageDelegate_")
...
@interface FolioReaderCenter (SWIFT_EXTENSION(EpubViewerKit)) <FolioReaderPageDelegate>
- (void)pageDidLoad:(FolioReaderPage * _Nonnull)page;
- (void)pageWillLoad:(FolioReaderPage * _Nonnull)page;
- (void)pageTap:(UITapGestureRecognizer * _Nonnull)recognizer;
@end
...
SWIFT_PROTOCOL("_TtP13EpubViewerKit25FolioReaderCenterDelegate_")
...
SWIFT_CLASS("_TtC13EpubViewerKit17FolioReaderConfig")
...
/// Reader container
SWIFT_CLASS("_TtC13EpubViewerKit20FolioReaderContainer")
...
SWIFT_PROTOCOL("_TtP13EpubViewerKit19FolioReaderDelegate_")
...
SWIFT_CLASS("_TtC13EpubViewerKit15FolioReaderPage")
...
SWIFT_CLASS("_TtC13EpubViewerKit18FolioReaderWebView")
...
/// A Highlight object
SWIFT_CLASS("_TtC13EpubViewerKit9Highlight")
...
@interface UIAlertController (SWIFT_EXTENSION(EpubViewerKit))
...
@interface UINavigationController (SWIFT_EXTENSION(EpubViewerKit))
@property (nonatomic, readonly) UIStatusBarStyle preferredStatusBarStyle;
@property (nonatomic, readonly) UIInterfaceOrientationMask supportedInterfaceOrientations;
@property (nonatomic, readonly) BOOL shouldAutorotate;
@end
